        ...
        <div class="row">
            <div class="col-xs-6 col-md-12 col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <form action="../admin/product/insert" enctype="multipart/form-data" method="post">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="featured" class="form-control" >
                                            <option @if (old('state') == 0) selected @endif value="0">Không</option>
                                            <option @if (old('state') == 1) selected @endif value="1">Có</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label>Trạng thái</label>
                                        <select name="state" class="form-control">
                                            <option @if (old('state') == 1) selected @endif value="1">Còn hàng</option>
                                            <option @if (old('state') == 0) selected @endif value="0">Hết hàng</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
