...
if (!function_exists("showCategoriesfrontend")) {
    function showCategoriesfrontend($categories, $parent, $char, $parent_id_child)
    {
        foreach ($categories as $item) {
            if ($item["parent"] == $parent) {
                if ($item['id'] == $parent_id_child) {
                    echo "<li><a href="."/menu/".$item["slug"].".html".">".$char.$item["name"]."</a></li>";
